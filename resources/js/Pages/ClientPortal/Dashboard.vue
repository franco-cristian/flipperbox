                    ...
                    >
                        <div class="p-6">
                            <h3 class="text-xl font-semibold text-gray-800 border-b pb-4 mb-4">
                                ...
                                <span class="font-mono bg-gray-100 text-gray-600 px-2 py-1 rounded-md text-base">{{
                                    vehiculo.patente
                                }}</span>
                            </h3>
                            <div v-if="vehiculo.work_orders && vehiculo.work_orders.length > 0">
                                ...
                                <ul class="space-y-3">
                                    <li
                                        ...
                                        :key="orden.id"
                                        class="p-3 border rounded-md hover:bg-gray-50 flex justify-between items-center"
                                    >
                                        <div>
