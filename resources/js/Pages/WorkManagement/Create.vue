                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="mb-6 p-4 border rounded-md">
                            ...
                            <p class="text-sm text-gray-600">
                                Cliente: {{ vehiculo.cliente.name }} {{ vehiculo.cliente.apellido }}
                            </p>
                            <p class="text-sm text-gray-600">Patente: {{ vehiculo.patente }}</p>
                            <p class="text-sm text-gray-600">
                                Modelo: {{ vehiculo.marca }} {{ vehiculo.modelo }} ({{ vehiculo.anio }})
                            </p>
                        </div>
                        <form @submit.prevent="submit">
                            <div>
                                <label for="description" class="block font-medium text-sm text-gray-700"
                                    >Descripción del Problema o Servicio Solicitado</label
                                >
                                <textarea
                                    id="description"
