...
// Recibimos las props que nos envía el controlador
...
// Inicializamos el formulario con los datos existentes del vehículo
const form = useForm({
...
const submit = () => {
    // Usamos el método PATCH para la actualización, pasando los IDs del cliente y vehículo
    form.patch(route('clientes.vehiculos.update', { cliente: props.cliente.id, vehiculo: props.vehiculo.id }), {
        preserveScroll: true,
    });
};
</script>
